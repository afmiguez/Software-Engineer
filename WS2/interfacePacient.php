<form action="interfacePacient.php" method="get">
...
$result = $client->call('WS2_Webservice.registerPacient', array('firstname' => $firstname, 'lastname' => $lastname, 'username' => $username, 'birthdate' => $birthdate, 'gender' => $gender));
