""" @package registerPacient.py
    This code would automate a caretaker register at the webservice 2
"""
...
"""Open the url of of the webservice 2 register caretaker interface."""
driver.get("http://192.168.163.128/ES-Project/WS2/interfaceCaretaker.php")

f = open('caretaker.txt', 'r')
for line in f:
	array=line.split(" ")
